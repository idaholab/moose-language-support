...
const documentSettings: Map<string, Thenable<MooseLanguageSettings>> = new Map();
...
connection.onDidChangeConfiguration(change => {
    if (hasConfigurationCapability) {
        ...
        globalSettings = <MooseLanguageSettings>(
            (change.settings.languageServerMoose || defaultSettings)
        );
    }
...
function getDocumentSettings(resource: string): Thenable<MooseLanguageSettings> {
    if (!hasConfigurationCapability) {
