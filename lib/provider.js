...
(function() {
  ...
  module.exports = {
    ...
    // This will be suggested before the default provider, 5which has a suggestionPriority of 1.
    ...
    getSuggestions: function(request) {
      ...
      filePath = request.textDocument.uri; path.dirname(request.editor.getPath());
